    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- NOTE: K (hover) and <C-s> (signature help) are now Neovim 0.12 defaults

          -- Remove 0.12 default gr* mappings that conflict with our `gr` for references.
          -- Deferred so they run after all LspAttach handlers (including the built-in one).
          vim.schedule(function()
      ...
      -- Configure and enable each LSP server using Neovim 0.12 native API
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      require('mini.ai').setup {
        -- Avoid conflicts with 0.12 treesitter incremental selection (see :help treesitter-incremental-selection)
        mappings = {
          around_next = 'aa',
          inside_next = 'ii',
        },
